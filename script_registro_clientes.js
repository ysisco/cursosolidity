...
async function guardarContract(razon_social,direccion,wallet) {
    try {
        const signer = provider.getSigner();
        const contractWithSigner = contract.connect(signer);
        console.log(contractWithSigner);
        const transaction = await contractWithSigner.createCustomer(razon_social,direccion,wallet)
...
document.getElementById("acceptButton").addEventListener("click", function() {   
    ...
    guardarContract(razon_social.value,direccion.value,wallet.value);
